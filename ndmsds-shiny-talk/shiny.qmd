...
fluidPage(
  titlePanel("Title displayed at the top"),
  sidebarLayout(
    sidebarPanel(
...
sliderInput(
  inputId = "name_to_reference_in_server",
...
::: notes
Now that we’ve explored the basics of Shiny, let’s take a closer look at Shiny widgets. Widgets are interactive elements that you can add to your Shiny app to enhance user experience and engagement. These widgets allow users to input data, make selections, and interact with the app in various ways.
:::
